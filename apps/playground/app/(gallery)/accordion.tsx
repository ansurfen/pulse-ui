  ...
  return (
    ...
    >
      <View style={styles.wrapper}>
        <View style={[styles.titleRow, { borderColor: colors.border.default, backgroundColor: colors.background.surface }]}>
          <Text style={[styles.primaryLink, { color: colors.text.link }]}>使用多邻国</Text>
        </View>
        ...
        >
          ...
          <Pressable style={styles.linkWrap}>
            <Text style={[styles.link, { color: colors.text.link }]}>查看更多</Text>
          </Pressable>
        </AccordionItem>

        <AccordionItem title="什么是连胜？">
          <Text style={[styles.body, { color: colors.text.primary }]}>连胜表示你连续完成学习任务的天数，可以作为坚持学习的反馈指标。</Text>
        </AccordionItem>

        <AccordionItem title="什么是排行榜和排行榜等级？">
          <Text style={[styles.body, { color: colors.text.primary }]}>排行榜用于和其他学习者比较活跃度，等级则表示你所在的分组段位。</Text>
        </AccordionItem>

        <AccordionItem title="多邻国使用开源库吗？">
          <Text style={[styles.body, { color: colors.text.primary }]}>可以在这里放许可证说明、外部链接，或者更完整的帮助文档内容。</Text>
        </AccordionItem>
        </Accordion>
      </View>
    </ScreenTemplate>
